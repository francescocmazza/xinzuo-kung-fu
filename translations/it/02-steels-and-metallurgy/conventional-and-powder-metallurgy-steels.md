...
La composizione è solo l'inizio. Una volta scelta la ricetta della lega, la domanda successiva è **come la chimica diventa acciaio solido**.

Due acciai con composizioni molto simili possono sviluppare diverse strutture interne perché solidificati in modi diversi. Ciò conta soprattutto negli acciai altamente legati, dove dimensioni e distribuzione locali del carburo possono influenzare l'affilatura, la resistenza all'usura e la resistenza all'usura.

La sequenza è semplice: la composizione determina ciò che è disponibile; l'industria siderurgica influisce sulla sua distribuzione uniforme; il trattamento termico sviluppa la struttura di lavoro finale.

## In primo luogo, foto l'interno di acciaio

L'acciaio sembra uniforme all'occhio, ma è fatto da molti cristalli microscopici chiamati **grains**. Insieme formano il metallo solido.

La parte continua ricca di ferro di tale struttura è chiamata **matrice**. All'interno della matrice possono essere presenti cristalli più duri chiamati **carbidi**, formatisi quando il carbonio si combina con elementi legati in ferro o carburo come cromo, vanadio, tungsteno o mannitolo.

Pensate alla matrice come il corpo continuo del materiale e dei carburi come particelle dure tenute al suo interno. Il confronto è semplificato, ma è sufficiente per capire perché il percorso di produzione conta.

Una matrice dura aiuta il tagliente a resistere alla deformazione. I carburi duri possono migliorare la resistenza all'usura. La loro dimensione, quantità e distribuzione** anche materia. Molti piccoli carburi distribuiti uniformemente si comportano in modo diverso da alcuni grandi grappoli anche quando la composizione chimica totale è la stessa.
...
La metallurgia delle polveri inizia anche con l'acciaio fuso. La differenza importante è quello che succede dopo.
...
Nessuna polvere sciolta rimane all'interno della lama finita. Il materiale finale è l'acciaio denso.
