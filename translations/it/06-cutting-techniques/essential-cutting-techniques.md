---
source_hash: 9f5228ff11e0d921a7f1a8202579bee32f602b5f23c2fbe4cebbaa79e0d00588
---
...
Impara un movimento alla volta, abbastanza lentamente per vedere cosa sta facendo la lama. La velocità dovrebbe venire dalla familiarità, mai essere il primo obiettivo.

Questo è gongfu coltello in pratica: un piccolo insieme di movimenti controllati ripetuti fino a diventare naturali senza perdere la consapevolezza.

## Prima del primo taglio

Tenere la tavola da scivolare con un panno umido o un tappetino antiscivolo sotto. Dovrebbe essere abbastanza grande per l'ingrediente, il coltello e una zona chiara per i pezzi tagliati.
...
La lama si alza e cade in un percorso per lo più verticale. Può muoversi leggermente in avanti mentre scende, ma non viaggia attraverso un grande arco. Una sezione larga, relativamente piatta del bordo incontra la tavola.

Questo si adatta a nakiri, santoku, bunka, molti gyuto e chine seavers. Un coltello da cuoco occidentale fortemente ricurvo può anche tagliare, ma una parte della sua pancia può rimanere sopra la tavola in un tratto perfettamente verticale.
...
4. Alzate il coltello solo abbastanza da liberare il cetriolo.
...
Il coltello dovrebbe fare contatto leggero e regolare con la tavola, non impatti pesanti. Se i pezzi rimangono uniti da pelli sottili, il bordo può essere troppo ricurvo per il movimento. Aggiungere un leggero movimento in avanti o utilizzare una sezione più piatta della lama.

### Perché funziona

Un bordo abbastanza dritto può contattare la tavola per gran parte della sua lunghezza in una volta. Ciò rende dritto triturare efficiente per le verdure e pezzi regolari. Una lama alta dà anche alla mano guida una grande, superficie prevedibile.
...
Il coltello si muove in avanti e verso il basso insieme. Il bordo entra vicino alla parte anteriore o centrale, viaggia attraverso l'ingrediente e termina con il tallone o mezzo toccando la tavola. Il coltello poi solleva e ritorna senza trascinare il bordo lateralmente.

Questo movimento si sente naturale con un ginecologo moderatamente piatto e funziona bene anche con santoku, bunka e nakiri.

### Provalo con una carota.

Tagliare un piccolo piatto sulla carota in modo che si riposi in modo sicuro. Iniziare con la metà anteriore del bordo sopra il cibo. Spostare il coltello in avanti mentre scende. Pensate di disegnare una breve linea diagonale attraverso la carota, piuttosto che cadere la lama dritto verso il basso.

Se la carota si rompe prima che il bordo passi, utilizzare meno forza e assicurarsi che il coltello si muova in avanti e in giù. Un bordo sottile taglia concentrando la forza e scivolando; non dovrebbe essere necessario dividere la verdura come un cuneo.

### Perché funziona

Un bordo taglia più efficacemente quando scivola attraverso il cibo. Il componente anteriore dà a ciascun punto del bordo un breve viaggio di affettatura invece di chiedergli di premere dritto attraverso. Una lama più piatta completa il taglio senza un grande movimento a dondolo.
...
Un lungo disegno diffonde il lavoro attraverso più del bordo. Riduce la compressione verso il basso e lascia una superficie di taglio più liscia. Questo importa con pesci delicati perché la qualità della superficie influisce sia l'aspetto che la consistenza.
...
### Ampia roccia rotante

Con un coltello da cuoco occidentale, la parte anteriore del bordo rimane sul bordo o vicino al bordo mentre il tallone si alza e cade. Il punto di contatto viaggia lungo la pancia curva come parte di una ruota. Alcuni gyuto anche rock bene; il profilo effettivo conta più dell'etichetta.
...
Raccogliere le foglie in una pila compatta. Con un coltello da cuoco ricurvo, posizionare la sezione di lavoro in avanti sulla tavola e rotolare attraverso la pancia. Con un nakiri a punta tonda, utilizzare la parte anteriore arrotondata come perno e sollevare e abbassare il tallone attraverso un corto arco. Tenere la mano guida in modo sicuro sulla colonna vertebrale o la parte superiore della lama, mai vicino al bordo. Ri-raccogliere le erbe con la faccia a lama larga, non il bordo.
...
Per fondere un pomodoro, stabilizzarlo sulla tavola, inserire solo la lunghezza necessaria della punta accanto al fusto e guidare un cerchio poco profondo. Per segnare la pelle o la pasticceria, utilizzare una leggera pressione e un movimento di disegno.

La punta appuntita di un coltello da ginecologo o da cuoco è versatile. La punta K di un bunka dà un'ottima visibilità, ma di solito è più sottile e vulnerabile. Un nakiri a punta tonda rinuncia deliberatamente al lavoro di piercing per un fronte robusto e prevedibile che supporta il taglio compatto del perno.
...
| 4 | Barbaforte/rafano/rafano | Perno stabile e uso naturale del profilo reale |
