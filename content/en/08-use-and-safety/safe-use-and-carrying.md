...
4. Check that the food is stable.
...
Kitchen knives are not interchangeable with every cutting tool.

A thin gyuto, santoku or nakiri is excellent for food preparation, but it is not designed to chop through heavy bone. A flexible fillet knife follows contours but should not be twisted against a hard joint. A deba can handle appropriate fish bones, but it is not a universal cleaver.

Using the correct knife protects both the user and the edge.
...
The steel and geometry were designed for cutting. Sideways force can damage an edge even when straight cutting force would be safe.
...
If the knife does not enter the food easily, pause and ask why. The edge may be dull. The ingredient may be unstable. The knife may be unsuitable. The cutting movement may not match the profile.

Forcing the blade creates several risks:

- the knife can slip;
- the food can move suddenly;
- the edge can wedge and release unpredictably;
...
Wooden and suitable plastic boards are generally gentle enough for quality knife edges.

Glass, ceramic, stone and metal surfaces are much harder than a cutting board should be. Each contact places severe pressure on the fine apex. The knife may feel dull very quickly or develop small chips.
...
The material-care reasons for hand washing, prompt drying and avoiding the dishwasher are covered in [Routine Knife Care](../09-maintenance/routine-care.md). During washing, the immediate safety problem is simpler: **the blade must remain visible and its edge path must remain controlled**.
...
The safest option is usually not to pass a knife directly from hand to hand.
...
When moving a short distance, keep the knife low, close and still.

The recommended position is:

1. Hold the handle firmly.
2. Keep the arm close to the side of the body.
3. Point the tip toward the floor.
4. Keep the cutting edge facing backward or otherwise away from the body.
5. Prevent the arm from swinging.
...
The protection should prevent the blade from sliding out and should not allow the edge to cut through the material.

For travel or transport outside the kitchen, local laws and venue rules must also be respected.
...
A loose knife in a drawer is unsafe and damages the edge as it strikes other utensils.

Magnetic strips should hold the knife securely. Place the spine against the strip first, then rotate the blade into position. When removing it, rotate the edge away before pulling. This avoids striking or scraping the edge against the magnet.

## What to do if a knife falls

Do not try to catch it.

Move the feet away and allow the knife to fall. Attempting to catch a sharp blade creates a much greater risk than allowing it to hit the floor.

Once it has stopped moving, pick it up carefully by the handle and inspect it for damage.

## Sharpness and safety

A dull knife should be sharpened rather than compensated for with force.

Signs that an edge needs attention include:
...
A sharp knife improves control, but the user must still maintain safe habits. Sharpness makes correct technique easier; it does not replace technique.

## Common unsafe habits

These mistakes are worth naming explicitly because they are easy to recognize and easy to correct during training.
...
Use a cutting board unless the task specifically calls for controlled in-hand work with a suitable small knife. A large blade and an unsupported ingredient create unnecessary risk.

### Testing sharpness by sliding a finger along the edge

Never slide a finger lengthwise along the cutting edge. That movement follows exactly the direction in which the edge is designed to cut. Use visual inspection or a controlled cutting test instead.

### Scraping the board with the cutting edge

Use the spine, the blade face or a bench scraper. Sideways scraping wears or damages the apex and creates a habit of moving a sharp edge laterally near the guiding hand.

### Using a glass, ceramic, stone or metal board

These surfaces rapidly damage a fine edge and can make controlled cutting less predictable. Use wood or a suitable plastic cutting board.

### Trying to catch a falling knife

Step back and let it fall. A damaged knife can be repaired or replaced; a hand injury is a far more serious consequence.
