...
The title of this book begins with an idea that is much broader than martial arts. *Kung fu* can describe a skill acquired through time, study, repetition and disciplined practice: something that gradually becomes reliable because knowledge has been understood, tested and turned into ability.
...
The principles presented in these pages are a synthesis of the knowledge I have accumulated over the years: personal study and experience, the experience gained inside Xinzuo, and the practical knowledge shared by colleagues involved in product development, manufacturing and sales. They represent the know-how I have developed and chosen to organize into a coherent view of kitchen knives.

They should be read in that spirit. This book does not claim to be an untouchable or final truth. Some points may deserve to be refined, developed further or corrected as experience grows and better information becomes available. That possibility is part of the project itself. The purpose is to state clearly what I currently consider useful, well-founded and worth teaching, so that it can be understood, tested, discussed and improved.

For the same reason, the chapters that follow do not repeatedly interrupt their explanations with general disclaimers. When the book reaches a conclusion, it states that conclusion directly. Qualifications are kept for the cases in which they genuinely change the technical meaning, the scope of a claim or the safe use of a knife. The general invitation to question, verify and improve the work belongs here, in the preface, rather than being repeated on every page.
